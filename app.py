...
# --- KİMLİK BİLGİLERİ (DOĞRUDAN FORMAT) ---
...
def load_data():
    try:
        ...
        # Tablonun adını veya ID'sini yazıyoruz (ID daha garantidir)
        sheet_id = "1NJob3RNvMZ43_JlG1hnaZmnF_I3bUW3BtW9bsNx6kB8"
...
if not data.empty:
    ...
    st.info("Veriler yükleniyor veya tablo boş...")
