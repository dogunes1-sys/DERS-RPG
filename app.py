...
# 1. HAM ANAHTAR (RAW STRING) - Python'un karakterleri bozmasını engeller
# r""" kullanımı tüm 'backslash' sorunlarını ortadan kaldırır.
...
no48LQIfpWFXD8PAMEba8qhSGjXZN7QA7huChluXFlH9E+ybdEwuqINszsSBtQrn0
...
try:
    ...
    if not df.empty:
        st.success("✅ Bağlantı kuruldu! Kahramanlar hazır.")
        ...
        if st.button(f"✨ {secilen}'e XP Ver"):
